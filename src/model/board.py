...
class Board:
  ...
  def computeSquaresAverage(self):
    ...
    # print('Squares Average......: {}'.format(self.__squaresAverage))                                                    COMMENTED OUT
  ...
  def scan(self, img):
    ...
    #print('THRESH......: {}'.format(thresh))                                                      # ADDED PRINT STATEMENT
    ...
    minArea = self.__squaresAverage * 0.32                                                        # ORIGINAL VALUE IS 0.25
    ...
    # self.print()                                                                                    # ADDED PRINT STATEMENT
    # print(self.squares)
    # print(detections)
